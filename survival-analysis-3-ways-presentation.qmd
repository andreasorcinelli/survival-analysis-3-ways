...
:::notes
When we plot those Kaplan Meier estimates stratified by internet service type 
:::
...
::: notes
We start by calculating the total number of customers in the sample. This is the total at start. 

Then we 

Iteratively updating the risk set. 
:::
