...
-   [ ] Add custom legend to this plot.
...
-   [ ] Sentence case or title case for titles?
...
## Plot Kaplan Meier Estimates {.smaller}
...
A **hazard** represents the probability of churning if a customer has not churned as of time t.
...
-   HR \< 1: reduced hazard of churn

-   HR \> 1: increased hazard of churn
...
It is essential to address **censoring** when you are working with time-to-event data. **Survival analyses** are a use set of tools.  
There are a few packages for implementing survival analysis in R.
